                            ...
                            <tr>
                                ...
                                <td width="27%" align="right">
                                    <table width="75%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="128" height="24" align="right" background="image/top.jpg"><img
                                                    src="image/bian.gif" width="128" height="24" border="0"
                                                    usemap="#Map"></td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <td height="29" background="./image/top_m.gif">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="top1" onClick="goto(1);" id="ttd1">
                        <a href="system/index.jsp" target="midFrame">系统管理</a>
                    </td>
                    <td><img src="./image/top_line.gif" width="2" height="29"></td>
                    <td class="top1" onClick="goto(8);" id="ttd8">
                        <a href="stock/index.jsp" target="midFrame">库存管理</a>
                    </td>
                    <td><img src="./image/top_line.gif" width="2" height="29"></td>
                    <td class="top1" onClick="goto(10);" id="ttd10">
