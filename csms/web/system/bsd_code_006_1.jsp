...
%>
<FORM NAME="idFrmMain" ID="idFrmMain" METHOD="POST" ACTION="/csms/system/DepotModifyServlet?id=<%=depot.getId()%>"
                ...
                <table border="0" width="100%" id="table1" cellspacing="1" cellpadding="2" bgcolor="gray">
                    <tr>
                        ...
                        <td class="textbar01" width="85%" colspan="1">
                            <input type="text" value="<%=depot.getDepotNumber()%>" name="depotNumber" size="15"
                                   disabled="true">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="textbar01" width="85%">
                            <input type="text" value="<%=depot.getDepot()%>" name="depot" size="15">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="textbar01" width="85%">
                            <input type="text" value="<%=depot.getSupervisor()%>" name="supervisor" size="15">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="textbar01" width="85%">
                            <input type="text" value="<%=depot.getTel()%>" name="tel" size="15">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="textbar01" width="85%">
                            <input type="text" value="<%=depot.getCapacity()%>" name="capacity" size="15">
                        </td>
                    </tr>
                </table>
